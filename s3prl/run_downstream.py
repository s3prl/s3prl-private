...
def get_downstream_args():
    ...
    assert (
        ...
        (not args.extract_scene_feature or args.downstream in ["lxt_sid4", "lxt_emotion", "voxceleb1"]) and
        # TODO (Joseph Feng): hidden set only implement PR, ASR
        (not args.use_extracted_feature or args.downstream in ("lxt_pr", "lxt_asr", "lxt_sid4", "lxt_emotion", "voxceleb1"))
    )

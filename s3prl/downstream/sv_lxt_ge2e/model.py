...
from .ge2e import LossFunction as Ge2e
...
class Ge2eLoss(nn.Module):
    def __init__(self, init_w=10.0, init_b=-5.0, n_uttr=5, **kwargs):
        super().__init__()
        self.ge2e = Ge2e(init_w, init_b)
        self.n_uttr = n_uttr
    
    def forward(self, x_BxH):
        x = x_BxH.view(-1, self.n_uttr, x_BxH.size(-1))
        # x: (n_spkr, n_uttr, hidden_size)

        loss, prec = self.ge2e(x)
        return loss, prec
